...
// SuiKeyGenerator 测试用例
func TestSuiKeyGenerator_GenerateKeyPair(t *testing.T) {
...
func TestSuiKeyGenerator_InvalidPrivateKey(t *testing.T) {
	generator := &SuiKeyGenerator{}
...
func TestSuiKeyGenerator_PublicKeyToAddress(t *testing.T) {
	generator := &SuiKeyGenerator{}
