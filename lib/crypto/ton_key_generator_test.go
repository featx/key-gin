...
func TestTonKeyGenerator_InvalidPrivateKey(t *testing.T) {
	generator := &TonKeyGenerator{}
...
func TestTonKeyGenerator_PublicKeyToAddress(t *testing.T) {
	generator := &TonKeyGenerator{}
